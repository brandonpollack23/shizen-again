        ...
        <div className="fixed inset-0 z-40 flex">
          <div
            className={clsx(
              ...
              'fixed inset-0 z-40 flex transition-transform duration-300 ease-in-out lg:hidden'
            )}
          >
            {/* Sidebar */}
            <div className="relative flex w-full max-w-xs flex-1 flex-col bg-white dark:bg-gray-800 pb-4">
